      ...
      <main className="flex-1">
        <section className="relative flex flex-col items-center px-6 pb-16 pt-20 text-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <Link
              href="/menu"
              className="inline-flex items-center gap-2 rounded-xl bg-accent-600 px-8 py-3.5 text-base font-semibold text-white transition-colors hover:bg-accent-500"
            >
              Ver menú
        ...
        <section className="mx-auto max-w-lg space-y-4 px-6 pb-15 pt-15">
          ...
          <div className="flex items-start gap-4 border-b border-neutral-100 pb-4">
            <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent-50">
              <svg className="h-4 w-4 text-accent-600" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
